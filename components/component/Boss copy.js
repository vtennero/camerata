  ...
  return (
    <div>
      ...
      <div
        ...
        // className="flex flex-col h-screen w-full border-t-2  dark:border-gray-800"
      >
        {/* <div key="1" className="flex flex-col h-screen w-full border-t-2 border-gray-100 dark:border-gray-800"> */}
        <div className="flex-1 ">
          {/* <div className="flex-1 border-b-2  dark:border-gray-800"> */}
          ...
          <div className="flex h-[60vh] items-stretch">
            <div className="hidden md:flex w-[400px]">
              ...
              {/* <div className="flex flex-col h-screen w-full border-t-2  dark:border-gray-800"> */}
